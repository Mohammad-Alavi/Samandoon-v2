define({ "api": [
  ...
  },
  {
    ...
    "name": "getFollowers",
    "type": "GET",
    "url": "/v1/user/{id}/followers?limit=10",
    "title": "Get Followers",
  ...
  },
  {
    ...
    "name": "getFollowings",
    "type": "GET",
    "url": "/v1/user/{id}/followings?limit=10",
  ...
  },
  {
    ...
    "name": "likeComment",
    "type": "POST",
    "url": "/v1/comment/:comment_id/like",
    "title": "Like Comment",
    "description": "<p>Like the given Comment</p>",
    "version": "1.0.0",
    "permission": [
      {
        "name": "Authenticated"
    ...
    "filename": "app/Containers/Comment/UI/API/Routes/LikeComment.v1.private.php",
    "groupTitle": "Like_Unlike",
    "success": {
      "examples": [
        {
  ...
  },
  {
    ...
    "name": "unlikeComment",
    "type": "POST",
    "url": "/v1/comment/:comment_id/unlike",
    "title": "Unlike Comment",
    "description": "<p>Unlike the given Comment</p>",
    "version": "1.0.0",
    "permission": [
      {
        "name": "Authenticated"
    ...
    "filename": "app/Containers/Comment/UI/API/Routes/UnlikeComment.v1.private.php",
    "groupTitle": "Like_Unlike",
    "success": {
      "examples": [
        {
  ...
  },
  {
    ...
    "name": "getLinkOGData",
    "type": "GET",
    "url": "/v1/content/link/og",
    "title": "Get Link OG Data",
    "description": "<p>Get the given link open graph data</p>",
    "version": "1.0.0",
    "permission": [
      {
        "name": "none"
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "url",
            "description": "<p>http://www.samandoon.ir this should be a complete url with http/s</p>"
          },
          {
            "group": "Parameter",
            "type": "boolean",
            "optional": false,
            "field": "get_all_meta_data",
            "description": "<p>0 or 1 | 0 = false and 1 = true</p>"
          }
        ]
      }
    },
    ...
    "filename": "app/Containers/Link/UI/API/Routes/GetLinkOGData.v1.private.php",
    "groupTitle": "Link"
  },
  {
    "group": "Localization",
  ...
  },
  {
    ...
    "name": "searchTag",
    "type": "GET",
    "url": "/v1/search/tag?q=ووته&tag_type=content",
    "title": "Search Tag",
    "description": "<p>Search the Tags and return the resault | Allowed Tag Types: content, subject</p>",
    "version": "1.0.0",
    "permission": [
      {
        "name": "Authenticated"
    ...
    "filename": "app/Containers/Tag/UI/API/Routes/SearchTag.v1.private.php",
    "groupTitle": "Search",
    "success": {
      "examples": [
        {
  ...
  },
  {
    ...
    "filename": "app/Containers/Storage/UI/API/Routes/DownloadConversionFiles.v1.private.php",
    "groupTitle": "Storage"
  },
  {
    "group": "Storage",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "birth",
            "description": "<p>date_format:Ymd' example:20141020</p>"
          },
          {
            "group": "Parameter",
            "type": "image",
